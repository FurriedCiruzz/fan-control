...
//////// Fuses: LP,XT,HSH,HSM,ECH_IO,RC,RC_IO,INTRC_IO,INTRC,ECM,ECM_IO,ECL
//////// Fuses: ECL_IO,PLLEN,NOPLLEN,PRIMARY_SW,PRIMARY,FCMEN,NOFCMEN,IESO
...
//////// Fuses: WDT32768,CCP2B3,CCP2C1,PBADEN,NOPBADEN,CCP3C6,CCP3B5,HFOFST
//////// Fuses: NOHFOFST,TIMER3B5,TIMER3C0,CCP2C0,CCP2B5,MCLR,NOMCLR,STVREN
//////// Fuses: NOSTVREN,LVP,NOLVP,XINST,NOXINST,DEBUG,NODEBUG,PROTECT
...
_bif void set_slow_slew_a(int1 value);  
_bif void set_slow_slew_b(int1 value);  
_bif void set_slow_slew_c(int1 value);  
_bif void set_slow_slew_e(int1 value);  
